...
def generate_launch_description():
    urdf = os.path.join(get_package_share_directory('mara_description'), 'urdf', 'module.urdf')
    ...
    ld = LaunchDescription([
        ...
        Node(package='mara_utils_scripts', node_executable='spawn_module.py', output='screen'),
        Node(package='hros_cognition_mara_components', node_executable='hros_cognition_mara_components', output='screen',
            arguments=["-motors", install_dir + "/share/hros_cognition_mara_components/module_order.yaml"])
    ])
    return ld
