...
def generate_launch_description():
    urdf = os.path.join(get_package_share_directory('mara_description'), 'urdf', 'mara_robot_gripper_140_no_table.urdf')
    ...
    ld = LaunchDescription([
        ...
        Node(package='mara_utils_scripts', node_executable='spawn_mara_arg.py', arguments=["mara_robot_gripper_140_no_table.urdf"], output='screen'),
