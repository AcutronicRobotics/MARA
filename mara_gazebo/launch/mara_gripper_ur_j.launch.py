...
def generate_launch_description():
    urdf = os.path.join(get_package_share_directory('mara_description'), 'urdf', 'mara_robot_gripper_ur_j.urdf')
    ...
    ld = LaunchDescription([
        ...
        Node(package='mara_utils_scripts', node_executable='spawn_mara_gripper_ur_j.py', output='screen'),
