...
#ifndef GAZEBO_ROBOTIQ_HAND_LINEAR_PLUGIN_HH
#define GAZEBO_ROBOTIQ_HAND_LINEAR_PLUGIN_HH
...
namespace gazebo
  {
  class RobotiqHandLinearPlugin : public gazebo::ModelPlugin
  {
    ...
    /// \brief Constructor.
    public: RobotiqHandLinearPlugin();

    /// \brief Destructor.
    public: virtual ~RobotiqHandLinearPlugin();
...
#endif  // GAZEBO_ROBOTIQ_HAND_LINEAR_PLUGIN_HH
